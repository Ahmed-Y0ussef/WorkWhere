        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalImg = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    NImg = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    NId = table.Column<long>(type: "bigint", maxLength: 14, nullable: false),
